...
function pixgraphy_social_links() { ?>
	<div class="social-links clearfix">
		...
		if( !empty($pixgraphy_settings['pixgraphy_social_linkedin']) ):
			echo '<li><a target="_blank" href="'.esc_url($pixgraphy_settings['pixgraphy_social_linkedin']).'"><i class="fa fa-linkedin"></i></a></li>';
		endif;
