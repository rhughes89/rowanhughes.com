...
$wp_customize->add_setting( 'pixgraphy_theme_options[pixgraphy_social_linkedin]', array(
	'default' => $pixgraphy_settings['pixgraphy_social_linkedin'],
	'sanitize_callback' => 'esc_url_raw',
	'type' => 'option',
	'capability' => 'manage_options'
	)
);
$wp_customize->add_control( 'pixgraphy_theme_options[pixgraphy_social_linkedin]', array(
	'priority' => 410,
	'label' => __( 'LinkedIn Link', 'pixgraphy' ),
	'section' => 'pixgraphy_social_icons',
	'type' => 'text',
	)
);
